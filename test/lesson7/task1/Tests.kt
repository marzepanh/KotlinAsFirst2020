...
и не надо при этом никуда торопиться___
    ...
    fun countSubstrings() {
        ...
        assertEquals(
            mapOf("6a" to 0, "ааааааб" to 2, "ббЬцбъчА" to 1),
            countSubstrings("input/substrings_in3.txt", listOf("6a", "ааааааб", "ббЬцбъчА"))
        )
    }
...
между                более               правой               парой               соседних               слов."""
    ...
    fun markdownToHtmlSimple() {
        ...
        //markdownToHtmlSimple("input/md_simple.md", "temp.html")
    }
    ...
    fun printDivisionProcess() {
        ...
        test(12, 9, "12 | 9\n-9   1\n--\n 3")
        test(59977, 68951, "59977 | 68951\n   -0   0\n-----\n59977")
        test(742898, 85141, " 742898 | 85141\n-681128   8\n-------\n  61770")
        test(1, 1, " 1 | 1\n-1   1\n--\n 0")
